...
class SentenceEncoder(nn.Module):
    def __init__(self, model_name='google/bert_uncased_L-2_H-128_A-2', cache_dir = "huggingface_models", use_bilstm=False, hidden_size=256):
    ...
    def forward(self, sentences, spans):
        ...
        return span_embeddings # List of tensors (variable size per sentence)
