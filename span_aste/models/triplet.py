...
class TripletClassifier(nn.Module):
    def __init__(self, input_dim, hidden_dim=768, num_classes=4, aspect_sentiment_only=False):
    ...
    def forward(self, inputs):
        ...
        if self.aspect_sentiment_only:
            ...
            for (span_pair, t_embed, o_embed, raw_distance) in inputs:
